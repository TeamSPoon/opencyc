...
public class Base64
{
    ...
    public static void main( String[] args )
    {
        try
        {
            ...
            // Test Input Stream
            {
                ...
                b64is.close();
                */
                bytes = Base64.readFile( "/home/reed/cvs/head/cycorp/cyc/java/org/opencyc/util/test.gif.b64", false );
   ...
   /**
     ...
     *
     * @param base64String the binary (CFASL) SubL request which is
     * encoded in Base64
     * @param trace the trace level
     * @return the decoded Cyc object
     */
    static public Object decodeCycObject (final String base64String, final int trace) throws IOException {
        byte[] base64Bytes = base64String.getBytes();
        ByteArrayInputStream byteArrayInputStream = new ByteArrayInputStream(base64Bytes);
        Base64.InputStream base64InputStream = new Base64.InputStream(byteArrayInputStream);
        CfaslInputStream cfaslInputStream = new CfaslInputStream(base64InputStream);
     ...
     * Base64 is used to embed the binary data in the XML SOAP document.
     *
     * @param obj the given Cyc object to encode
     * @param trace the trace level
     * @return the Base64 encoded string
     */
    static public String encodeCycObject (final Object obj, final int trace) throws IOException {
        ...
        ByteArrayOutputStream base64ByteStream = new ByteArrayOutputStream();
        Base64.OutputStream base64OutputStream = new Base64.OutputStream(base64ByteStream);
